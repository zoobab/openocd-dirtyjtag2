...
static struct version_specific dirtyjtag_v_options[4] = {{0, 240}, {0, 240}, {NO_READ, 496}, {NO_READ, 4000}};
...
static int dirtyjtag_getversion(void)
{
	...
	{
		dirtyjtag_version = 2; //this code does not support version 3
	}
	else
	{
